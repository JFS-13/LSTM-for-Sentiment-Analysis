% Test LSTM Best Adagrad

% This script evaluates the best LSTM model trained using the Adagrad 
...
% --- 1. DATA LOADING ---
disp('Caricamento dati Test e Rete LSTM Adagrad...');
if isfile('ready_data.mat') && isfile('best_lstm_adagrad.mat')
    load('ready_data.mat', 'X_Test', 'Y_Test');
    load('best_lstm_adagrad.mat'); 
else
    error('File mancanti! Esegui prima load_twitterdata_optimized e train_lstm_adagrad.');
end
...
fprintf('Valutazione (Adagrad) su %d tweet di test...\n', num_test);
t_start = tic;
...
% --- 4. RESULTS OUTPUT ---
fprintf('\n=====================================\n');
fprintf('   RISULTATI FINALI TEST (ADAGRAD)\n');
fprintf('=====================================\n');

% Test LSTM Best RMSprop

% This script evaluates the best LSTM model trained using the RMSprop 
...
% --- 1. DATA LOADING ---
disp('Caricamento dati Test e Rete LSTM RMSprop...');
if isfile('ready_data.mat') && isfile('best_lstm_rmsprop.mat')
    load('ready_data.mat', 'X_Test', 'Y_Test');
    load('best_lstm_rmsprop.mat'); 
else
    error('File mancanti! Esegui prima load_twitterdata_optimized e train_lstm_rmsprop.');
end
